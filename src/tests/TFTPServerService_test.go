...
type tftpServiceTester struct {
	configRepo      interfaces.IGenericRepository[domain.TFTPConfig]
...
func Test_TFTPServerService_Prepare(t *testing.T) {
	...
	logger := logrus.New()
	tftpTester.configRepo = infrastructure.NewGormGenericRepository[domain.TFTPConfig](testGenDb, logger)
	tftpTester.pathsRepo = infrastructure.NewGormGenericRepository[domain.TFTPPathRatio](testGenDb, logger)
	tftpTester.manager = infrastructure.NewTFTPServerManager(logger)
	if err != nil {
		t.Error("failed to create switch port repository")
	}
	tftpTester.service = services.NewTFTPServerService(tftpTester.configRepo, tftpTester.pathsRepo, tftpTester.manager)
	if err != nil {
...
func Test_TFTPServerService_InitializeTest(t *testing.T) {
	...
	err := services.TFTPServerServiceInitialize(tftpTester.service)
	if err != nil {
...
func Test_TFTPServerService_GetList(t *testing.T) {
	servers, err := tftpTester.service.GetList(context.Background(), "", "", "", 1, 1)
	if err != nil {
...
func Test_TFTPServerService_GetByID(t *testing.T) {
	server, err := tftpTester.service.GetByID(context.Background(), tftpTester.createdServerID)
	if err != nil {
...
func Test_TFTPServerService_Create(t *testing.T) {
	dto := dtos.TFTPConfigCreateDto{
		TFTPConfigBaseDto: dtos.TFTPConfigBaseDto{
	...
	server, err := tftpTester.service.Create(context.Background(), dto)
	if err != nil {
...
func Test_TFTPServerService_Update(t *testing.T) {
	...
	server, err := tftpTester.service.Update(context.Background(), dto, tftpTester.deleteServerID)
	if err != nil {
...
func Test_TFTPServerService_Delete(t *testing.T) {
	err := tftpTester.service.Delete(context.Background(), tftpTester.deleteServerID)
	if err != nil {
		t.Errorf("delete tftp server failed: %q", err)
	}
	_, err = tftpTester.service.GetByID(context.Background(), tftpTester.deleteServerID)
	if err == nil {
...
func Test_TFTPServerService_GetPaths(t *testing.T) {
	paths, err := tftpTester.service.GetPaths(context.Background(), tftpTester.createdServerID, "", "", 1, 10)
	if err != nil {
